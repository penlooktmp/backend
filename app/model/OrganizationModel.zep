...
class OrganizationModel extends Model
{
     ...
     * @return int
     */
    public function addOrganization(var parent_name, var org_name, var nationality, var type)
    {
        var new_org;
        let new_org = new Org();
        new_org->save([
     ...
     * @param string $color
     */
    public function updateOrganization(var id, var subtitle, var address, var phone, var website, var description, var image, var color)
    {
        var org;
